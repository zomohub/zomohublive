...
function Wo_SeoLink($query = '') {
    ...
    if ($wo['config']['seoLink'] == 1) {
        $query = preg_replace(array(
            ...
            '/^index\.php\?link1=streams$/i',
            '/^index\.php\?link1=streams-genre&genre=([A-Za-z-]+)$/i',
            '/^index\.php\?link1=streams-country&country=([A-Za-z-]+)$/i',
            ...
            '/^index\.php\?link1=directory-streams/i',
            ...
            $config['site_url'] . '/streams/',
            $config['site_url'] . '/streams/genre/$1/',
            $config['site_url'] . '/streams/country/$1/',
            $config['site_url'] . '/streams/watch/$1',
            ...
            $config['site_url'] . '/directory/streams',
