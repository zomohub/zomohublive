        ...
        if (!empty($Userdata['user_id'])) {
            ...
            if (empty($errors)) {
                $Update_data = array(
                    ...
                    'user_interest' => (isset($_POST['user_interest']))?Wo_Secure(implode(",", $_POST['user_interest'])):'',
                    'user_language' => (isset($_POST['user_language']))?Wo_Secure(implode(",", $_POST['user_language'])):'',
